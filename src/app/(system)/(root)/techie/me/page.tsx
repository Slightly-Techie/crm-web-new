...
import { ITechie, WithoutNullableKeys } from "@/types/types";
import { logToConsole } from "@/lib/utils";
import Image from "next/image";
import { ChangeEvent, FormEvent, useState } from "react";
import { Form, useForm } from "react-hook-form";
import { useQuery } from "@tanstack/react-query";
import PageTitle from "../../components/pagetitle";
import { REGEXVALIDATION } from "@/constants/constants";
import { getStacks } from "@/hooks/use_endpoints";
import { Oval } from "react-loader-spinner";
import { getSkillsArray } from "@/lib/utils";
import { toast } from "sonner";
import { Status } from "@/types/types";
import { UserPlusIcon } from "lucide-react";

type inputField = WithoutNullableKeys<Omit<ITechie, "id" | "skills">>;
type InitialField = inputField & Record<"skills", string>;
